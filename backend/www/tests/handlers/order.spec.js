...
var order_store = new order_1.OrderModel();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // Create a token before starting the tests to use it in the backend
                    token = _a.sent();
                    created_user_id = createUser.id;
                    return [2 /*return*/];
            }
        });
    }); });
    //    Current Order by user (args: user id)[token required]
    it('should return the current order "open status" of the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var order, createOrder, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    order = {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, request
                            .get("/user/".concat(created_user_id, "/orders"))
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, connection_pool.query('ALTER SEQUENCE orders_id_seq RESTART WITH 1')];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, connection_pool.query('TRUNCATE TABLE orders CASCADE')];
                case 4:
                    _a.sent();
