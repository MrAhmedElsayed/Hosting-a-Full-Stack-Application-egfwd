...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.show = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find user ".concat(userId, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    UserStore.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, hashedPassword, result, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("could not create product: ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    UserStore.prototype.authenticate = function (username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, user, isValid, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not authenticate user ".concat(username, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
