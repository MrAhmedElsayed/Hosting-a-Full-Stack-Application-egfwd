        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw new Error("could not get orders: ".concat(error_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderModel.prototype.show = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("could not get user ".concat(userId, " orders: ").concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderModel.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [data.status, data.user_id])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("could not create order: ".concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
