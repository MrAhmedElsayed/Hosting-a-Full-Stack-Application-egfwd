...
var userRoutes = function (app) {
    ...
    app.get('/users', verifyAuthTokenMIDD_1.verifyAuthToken, index);
    app.get('/users/:userId/', verifyAuthTokenMIDD_1.verifyAuthToken, show);
    // app.post('/users', verifyAuthToken, create)
    app.post('/users', create);
};
var authenticate = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userAuth, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                userAuth = _a.sent();
                if (!userAuth) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, generateToken_1.generateToken)(userAuth)];
            case 3:
                token = _a.sent();
                res.json({
                    token: token,
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, createUser, token, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
