  ...
  <v-card>
    ...
    <v-row class="ma-0 pb-5 px-2">
      ...
      <v-col cols="9" sm="10">
        ...
        <small
          >font-size: 0.875rem / line-height: 1.375rem / font-weight: 500</small
        >
      </v-col>
      ...
      <v-col cols="9" sm="10">
        ...
        <small
          >font-size: 0.875rem / line-height: 1.25rem / font-weight: 400</small
        >
      </v-col>
      ...
      <v-col cols="9" sm="10">
        ...
        <small
          >font-size: 0.75rem / line-height: 1.25rem / font-weight: 400</small
        >
      </v-col>
