        ...
        <v-card>
          ...
          <v-card-text class="position-relative">
            ...
            <div class="d-flex justify-space-between flex-wrap pt-12">
              <div class="me-2 mb-2">
                <v-card-title class="pt-0 px-0"> Robert Meyer </v-card-title>
                <v-card-subtitle class="text-xs pa-0">
                  London, UK
                </v-card-subtitle>
              </div>
              <v-btn color="primary"> send request </v-btn>
            </div>
            <!-- Mutual Friends -->
          ...
          <v-row class="ma-0 h-full">
            ...
            >
              <div class="membership-pricing">
                ...
                <v-btn color="primary" class="mt-6"> Contact Now </v-btn>
              </div>
            </v-col>
          </v-row>
        </v-card>
      ...
      <v-col cols="12" lg="4" md="6">
        <v-card>
          ...
          <v-card-text>
            ...
            are a myriad of choices. Here’s a rundown of some of the best
            systems available.
          </v-card-text>
          <v-card-text>
            The following non-standard attributes are available on some
            browsers.
          </v-card-text>
          <v-card-actions class="dense">
            <v-btn color="primary" text large> Read More </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
      <!-- The Best Answers -->
      <v-col cols="12" md="6" lg="4">
        <v-card>
          ...
          <v-card-text>
            ...
            resist. Printing is a widely use process in making printed materials
            that are used for advertising.
          </v-card-text>
          <v-card-text>
            become fast, easy and simple. If you want your promotional material
            to be an eye-catching
          </v-card-text>
          <v-card-actions class="dense">
            <v-btn text color="primary" large> Location </v-btn>
            <v-btn text color="primary" large> Reviews </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
      <!-- Support -->
      <v-col cols="12" md="6" lg="4" class="align-self-start">
        <v-card color="text-center">
          ...
          <v-card-text>
            <v-btn color="primary" class="mt-4"> Contact Now </v-btn>
          </v-card-text>
        </v-card>
      </v-col>
    </v-row>
